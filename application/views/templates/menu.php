				...
				<div class="d-flex align-items-center justify-content-between">
					<div class="iq-navbar-logo d-flex align-items-center justify-content-between">
						...
						<a href="index.html" class="header-logo">
							...
							<img src="<?php echo base_url(); ?>assets/images/logo-white.png" class="img-fluid rounded-normal darkmode-logo"
								alt="logo">
						</a>
					</div>
						...
						<nav class="iq-sidebar-menu">
							...
							<ul id="iq-sidebar-toggle" class="iq-menu d-flex">
								...
								<li class=" ">
									...
									<ul id="pages" class="iq-submenu sub-scrll collapse"
										...
										<li class=" ">
											<a href="#others" class="collapsed" data-toggle="collapse"
												aria-expanded="false">
												<span>Others</span>
												<i class="ri-arrow-right-s-line iq-arrow-right"></i>
											</a>
							...
							<ul class="navbar-nav ml-auto navbar-list align-items-center">
												...
												<div class="p-2">
														...
														<div class="media align-items-center cust-card p-2">
															<div class="">
																<img class="avatar-40 rounded-small"
																	src="<?php echo base_url(); ?>assets/images/user/u-1.jpg" alt="01">
															</div>
													...
													<a href="#" class="iq-sub-card">
														<div class="media align-items-center cust-card p-2">
															<div class="">
																<img class="avatar-40 rounded-small"
																	src="<?php echo base_url(); ?>assets/images/user/u-2.jpg" alt="02">
															</div>
															<div class="media-body ml-3">
													...
													<a href="#" class="iq-sub-card">
														<div class="media align-items-center cust-card p-2">
															<div class="">
																<img class="avatar-40 rounded-small"
																	src="<?php echo base_url(); ?>assets/images/user/u-3.jpg" alt="03">
															</div>
															<div class="media-body ml-3">
								...
								<li class="caption-content">
									<a href="#" class="search-toggle dropdown-toggle d-flex align-items-center"
										...
										aria-expanded="false">
										<img src="<?php echo base_url(); ?>assets/images/user/01.jpg" class="avatar-40 img-fluid rounded"
											alt="user">
