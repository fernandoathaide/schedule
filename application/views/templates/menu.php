    							...
    							<ul class="navbar-nav ml-auto navbar-list align-items-center">
    												...
    												<div class="p-2">
    														...
    														<div class="media align-items-center cust-card p-2">
    															<div class="">
    																<img class="avatar-40 rounded-small"
    																	src="<?php echo base_url(); ?>assets/images/user/u-1.jpg"
    																	alt="01">
    															</div>
    													...
    													<a href="#" class="iq-sub-card">
    														<div class="media align-items-center cust-card p-2">
    															<div class="">
    																<img class="avatar-40 rounded-small"
    																	src="<?php echo base_url(); ?>assets/images/user/u-2.jpg"
    																	alt="02">
    															</div>
    															<div class="media-body ml-3">
    													...
    													<a href="#" class="iq-sub-card">
    														<div class="media align-items-center cust-card p-2">
    															<div class="">
    																<img class="avatar-40 rounded-small"
    																	src="<?php echo base_url(); ?>assets/images/user/u-3.jpg"
    																	alt="03">
    															</div>
    															<div class="media-body ml-3">
    								...
    								<li class="caption-content">
    									<a href="#" class="search-toggle dropdown-toggle d-flex align-items-center"
    										...
    										aria-expanded="false">
    										<img src="<?php echo base_url(); ?>assets/images/user/01.jpg"
